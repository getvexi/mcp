    ...
    tools: [
        {
            ...
            inputSchema: {
                ...
                properties: {
                    ...
                    wait: {
                        type: "boolean",
                        description: "Wait up to 90 seconds for crawls to complete before returning. Use when user wants fresh results.",
                    },
                },
            },
        },
